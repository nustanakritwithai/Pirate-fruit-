...
export const STAT_BUILD_PRESETS: readonly StatBuildPreset[] = [
  // --- Max Level ---
  {
    ...
    allocation: { melee: MAX, defense: MAX, sword: MAX, gun: MIN, fruit: MIN },
  ...
  },
  {
    ...
    allocation: { melee: MAX, defense: MAX, sword: MIN, gun: MAX, fruit: MIN },
  ...
  },
  {
    ...
    allocation: { melee: MAX, defense: MAX, sword: MIN, gun: MIN, fruit: MAX },
  ...
  },
  {
    ...
    allocation: { melee: 801, defense: MAX, sword: 2000, gun: MIN, fruit: 2000 },
  ...
  },
  {
    ...
    allocation: { melee: MAX, defense: 1400, sword: MIN, gun: MIN, fruit: MAX },
  ...
  },
  {
    ...
    allocation: { melee: 1400, defense: MAX, sword: MIN, gun: MIN, fruit: MAX },
    tags: ['dps', 'grinding'],
  },
  // --- Level 1300 ---
  {
    ...
    allocation: { melee: 2600, defense: 1300, sword: MIN, gun: MIN, fruit: MIN },
  ...
  },
  {
    ...
    allocation: { melee: 350, defense: 1300, sword: 2250, gun: MIN, fruit: MIN },
    tags: ['sword', 'mid-game'],
  },
  {
    id: 'lv1300-gun-main',
    ...
    allocation: { melee: 350, defense: 1300, sword: MIN, gun: 2250, fruit: MIN },
    tags: ['gun', 'mid-game'],
  },
  {
    ...
    allocation: { melee: 350, defense: 1300, sword: MIN, gun: MIN, fruit: 2350 },
  ...
  },
  {
    ...
    allocation: { melee: 780, defense: 780, sword: 780, gun: 780, fruit: 780 },
    tags: ['hybrid', 'versatile'],
  },
  {
    ...
    allocation: { melee: 1300, defense: 1300, sword: 1300, gun: MIN, fruit: MIN },
    tags: ['balanced'],
  },
] as const;
