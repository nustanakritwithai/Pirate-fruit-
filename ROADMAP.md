...
- [x] เกาะที่ 6 **เกาะภูผาอัคคี** (Lv.91-110): หมู่บ้านช่างตี ลานลาวา เหมืองออบซิเดียน ป้อมลัทธิ และปล่องไททัน
- [x] ตะขาบลาวา Lv.91, สาวกลัทธิเถ้าถ่าน Lv.95, โกเลมออบซิเดียน Lv.102, บอสไททันแมกมา Lv.108
- [x] NPC ภูผา 4 คน + ภารกิจ 4 งาน + Ocean Overview/Save/Checkpoint รองรับหกเกาะ
- [ ] เกาะที่ 7 และเส้นทาง World Progression ช่วง Lv.111+
