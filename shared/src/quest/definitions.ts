/**
 * S10 — นิยามเควสต์เป็นแหล่งเดียว (single source of truth)
 * ย้ายมาจาก client/src/quest/QuestDefinitions.ts เพื่อให้ Server ตัดสินรางวัล
 * จาก databook เดียวกับที่เกมแสดงผล — Client จะ re-export จากไฟล์นี้
 * ห้ามฝั่งใดฝั่งหนึ่งแก้เลขรางวัลเองโดยไม่ผ่านไฟล์นี้
 */
...
export const QUEST_DEFINITIONS: readonly QuestDefinition[] = [
  ...
  { id: 'tempest-cloud-crabs', name: 'ก้ามสายฟ้าเหนือเมฆ', description: 'กำจัดปูเมฆสายฟ้า 7 ตัวรอบสวนเมฆและทางตะวันออก', minimumLevel: 71, repeatable: true, objectives: [{ type: 'kill', targetId: 'cloud-crab', requiredAmount: 7 }], rewards: { playerExp: 7200, coins: 4600, masteryBonus: 760 } },
  { id: 'tempest-sky-raiders', name: 'โจรผู้ขโมยสายลม', description: 'ปราบโจรเวหา 6 คนที่คุมทางขึ้นวิหาร', minimumLevel: 75, repeatable: true, objectives: [{ type: 'kill', targetId: 'sky-raider', requiredAmount: 6 }], rewards: { playerExp: 8400, coins: 5500, masteryBonus: 880 } },
  { id: 'tempest-storm-golems', name: 'หัวใจโรงตีพายุ', description: 'ทำลายโกเลมผลึกพายุ 5 ตนในโรงตีทางเหนือ', minimumLevel: 81, repeatable: true, objectives: [{ type: 'kill', targetId: 'storm-golem', requiredAmount: 5 }], rewards: { playerExp: 10200, coins: 7000, masteryBonus: 1050 } },
  { id: 'eternal-tempest-lord', name: 'บัลลังก์เหนือพายุ', description: 'โค่นเจ้าแห่งพายุนิรันดร์ที่วิหารยอดเกาะ', minimumLevel: 85, repeatable: true, objectives: [{ type: 'boss', targetId: 'tempest-lord-boss', requiredAmount: 1 }], rewards: { playerExp: 14500, coins: 9800, masteryBonus: 1450 } },
  { id: 'ember-lava-crawlers', name: 'เขี้ยวใต้ธารลาวา', description: 'กำจัดตะขาบลาวา 7 ตัวรอบทุ่งลาวาและทางเถ้าตะวันออก', minimumLevel: 91, repeatable: true, objectives: [{ type: 'kill', targetId: 'lava-crawler', requiredAmount: 7 }], rewards: { playerExp: 17000, coins: 11600, masteryBonus: 1680 } },
  { id: 'ember-ash-cultists', name: 'เถ้าถ่านแห่งคำลวง', description: 'ปราบสาวกลัทธิเถ้าถ่าน 6 คนที่ป้อมฝั่งตะวันตก', minimumLevel: 95, repeatable: true, objectives: [{ type: 'kill', targetId: 'ash-cultist', requiredAmount: 6 }], rewards: { playerExp: 19500, coins: 13500, masteryBonus: 1920 } },
  { id: 'ember-obsidian-golems', name: 'หัวใจสีดำในเหมือง', description: 'ทำลายโกเลมออบซิเดียน 5 ตนในเหมืองตะวันออก', minimumLevel: 101, repeatable: true, objectives: [{ type: 'kill', targetId: 'obsidian-golem', requiredAmount: 5 }], rewards: { playerExp: 23500, coins: 16800, masteryBonus: 2280 } },
  { id: 'awakened-magma-titan', name: 'หัวใจภูผาอัคคี', description: 'โค่นไททันแมกมาบรรพกาลที่ปล่องกลางเกาะ', minimumLevel: 105, repeatable: true, objectives: [{ type: 'boss', targetId: 'magma-titan-boss', requiredAmount: 1 }], rewards: { playerExp: 33000, coins: 23500, masteryBonus: 3200 } },
  {
...
export function isQuestObjectivesComplete(
